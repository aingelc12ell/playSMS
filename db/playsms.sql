...
(0, 20, 1, 'core', 'main_config', 'default_user_status', '3'),
(0, 21, 1, 'core', 'main_config', 'enable_logo', '1'),
(0, 22, 1, 'core', 'main_config', 'logo_url', 'plugin/themes/common/images/playSMS_logo_full.png'),
(0, 23, 1, 'core', 'main_config', 'logo_replace_title', '1'),
(0, 24, 1, 'core', 'main_config', 'layout_footer', 'Application footer here. Go to main configuration or manage site to edit this footer.'),
(0, 25, 1, 'core', 'main_config', 'buy_credit_page_title', 'Buy credit'),
(0, 26, 1, 'core', 'main_config', 'buy_credit_page_content', 'Go to main configuration or manage site to edit this page'),
(0, 27, 1, 'core', 'main_config', 'information_title', 'Information'),
(0, 28, 1, 'core', 'main_config', 'information_content', '<p>Go to main configuration or manage site to edit this page</p>'),
(0, 31, 1, 'core', 'main_config', 'username_length', '30'),
(0, 32, 1, 'core', 'main_config', 'plus_sign_remove', '0'),
(0, 33, 1, 'core', 'main_config', 'plus_sign_add', '0'),
(0, 34, 1, 'core', 'main_config', 'enable_credit_unicode', '0'),
(0, 35, 1, 'core', 'main_config', 'brute_force_detection', '1'),
(0, 36, 1, 'core', 'main_config', 'keyword_separator', ''),
(0, 37, 1, 'core', 'main_config', 'credit_lowest_limit', '0'),
(0, 38, 1, 'core', 'main_config', 'sms_limit_per_hour', '0'),
(0, 39, 1, 'core', 'main_config', 'default_replace_zero', ''),
(0, 40, 1, 'core', 'main_config', 'default_parent', '0'),
(0, 41, 1, 'core', 'main_config', 'default_acl', '0'),
(0, 42, 1, 'core', 'main_config', 'disable_login_as', '0'),
(0, 43, 1, 'core', 'main_config', 'enhance_privacy_subuser', '0');
